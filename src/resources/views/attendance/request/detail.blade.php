...
@section('head-title', '申請詳細')

@section('css')
<link rel="stylesheet" href="{{ asset('css/attendance/request/detail.css') }}">
@endsection
...
@section('content')
    <div class="detail__content">
        <div class="detail__inner">
            ...
            <form action="{{ route('attendance.request.show', ['id' => $attendanceRequest->id]) }}" method="POST" class="detail__form">
                @csrf
